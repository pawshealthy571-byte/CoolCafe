        ...
        <form id="menu-form" class="flex-1 min-h-0 flex flex-col">
            ...
            <div>
                ...
                <div class="mt-2 flex items-center gap-3">
                    <button type="button" onclick="promptImageUrl()" class="flex-1 bg-gray-100 border border-gray-100 py-3 rounded-2xl text-[10px] font-bold text-gray-600 hover:bg-gray-200 transition-all uppercase tracking-widest">
                        <i class="fas fa-image mr-2"></i> Pilih / Masukkan URL Foto
                    </button>
...
<script>
    ...
    function promptImageUrl() {
        const currentUrl = document.getElementById('menu-image').value;
        const url = prompt('Masukkan URL foto menu (dari internet):', currentUrl);
        if (url !== null) {
    ...
    document.getElementById('menu-form').addEventListener('submit', async (e) => {
        ...
        if (response.ok) {
            ...
            alert('Gagal menyimpan menu. Periksa input Anda.');
        }
    });
